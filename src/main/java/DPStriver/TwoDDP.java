...
class TwoDDP {
    ...
    static int spaceOptimization(int n, int points[][]){
        int prev[] = new int[4];
    ...
    //tabulation approach
    static int tabulationApproach(int n, int points[][]){
        int[][] dp = new int[n][4];
    ...
    public static void main(String args[]) {
        ...
        System.out.println("tabulationApproach(n, points) = " + tabulationApproach(n, points));

        System.out.println("spaceOptimization(n, points) = " + spaceOptimization(n, points));
    }
}
